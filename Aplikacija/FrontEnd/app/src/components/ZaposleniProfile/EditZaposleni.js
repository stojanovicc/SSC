...
export default function EditZaposleniProfileDialog({currentName, currentLastName, currentPicture, update,}) {
    ...
    const handleSubmit = () => {
        fetch("http://localhost:7240/Account/EditZaposleni?firstName=" + name + "&lastName=" + lastName + "&picture=" + filename,
            {
                method: "PUT",
                credentials: "include",
            }
