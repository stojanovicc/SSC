...
export default function EditTrenerProfileDialog({currentName, currentLastName, currentPicture, update,}) {
    ...
    const handleSubmit = () => {
        fetch("http://localhost:7240/Account/EditTrener?firstName=" + name + "&lastName=" + lastName + "&picture=" + filename,
            {
                method: "PUT",
                credentials: "include",
            }
